#!/bin/bash
#
# Experiment 1c: Decoder with 4 layers (deeper)
#
# Usage:
#   bash scripts/run_exp1c.sh [GPU_ID]
#
# Example:
#   bash scripts/run_exp1c.sh 0     # Run on GPU 0
#   bash scripts/run_exp1c.sh 1     # Run on GPU 1
#
...
echo "════════════════════════════════════════════════════════════════════════"
echo "  Experiment 1c: Decoder with ${DECODER_LAYERS} layers (deeper)"
echo "════════════════════════════════════════════════════════════════════════"
echo ""
echo "Configuration:"
