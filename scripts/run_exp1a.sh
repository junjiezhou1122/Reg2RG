#!/bin/bash
#
# Experiment 1a: Decoder with 1 layer (baseline)
#
# Usage:
#   bash scripts/run_exp1a.sh [GPU_ID]
#
# Example:
#   bash scripts/run_exp1a.sh 0     # Run on GPU 0
#   bash scripts/run_exp1a.sh 1     # Run on GPU 1
#
...
echo "════════════════════════════════════════════════════════════════════════"
echo "  Experiment 1a: Decoder with ${DECODER_LAYERS} layer (baseline)"
echo "════════════════════════════════════════════════════════════════════════"
echo ""
echo "Configuration:"
