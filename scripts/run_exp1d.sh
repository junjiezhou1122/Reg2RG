#!/bin/bash
#
# Experiment 1d: Decoder with 6 layers (deepest)
#
# Usage:
#   bash scripts/run_exp1d.sh [GPU_ID]
#
# Example:
#   bash scripts/run_exp1d.sh 0     # Run on GPU 0
#   bash scripts/run_exp1d.sh 1     # Run on GPU 1
#
...
echo "════════════════════════════════════════════════════════════════════════"
echo "  Experiment 1d: Decoder with ${DECODER_LAYERS} layers (deepest)"
echo "════════════════════════════════════════════════════════════════════════"
echo ""
echo "Configuration:"
